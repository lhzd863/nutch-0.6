...
public class NDFSClient implements FSConstants {
    public static final Logger LOG = LogFormatter.getLogger("net.nutch.fs.NDFSClient");
    ...
    public NDFSClient(InetSocketAddress namenode) {
        ...
        this.leaseChecker = new Thread(new LeaseChecker());
    ...
    private class NameNodeCaller {
        private net.nutch.ipc.Client client;
        ...
        public NameNodeCaller(InetSocketAddress namenode) {
            this.client = new net.nutch.ipc.Client(FSResults.class);
        ...
        private synchronized FSResults call(FSParam p, InetSocketAddress target) throws IOException {
            ...
            while (results == null) {
                try {
                    ...
                    client = new net.nutch.ipc.Client(FSResults.class);
                }
            }
            return results;
        }
