...
public class FSNamesystem implements FSConstants {
    public static final Logger LOG = LogFormatter.getLogger("net.nutch.fs.FSNamesystem");
    ...
    Thread hbthread = null, lmthread = null;
    ...
    public FSNamesystem(File dir) throws IOException {
        ...
        this.hbthread = new Thread(new HeartbeatMonitor());
        this.lmthread = new Thread(new LeaseMonitor());
        hbthread.start();
        lmthread.start();
