 ...
 */
public class OntologyImpl implements net.nutch.ontology.Ontology {
  public static final Logger LOG =
    LogFormatter.getLogger("net.nutch.ontology.Ontology");
  ...
  public static Ontology getInstance () {
    if (ontology == null) {
      //ontology = new net.nutch.ontology.Ontology();
